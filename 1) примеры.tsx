...
1) хранить канвасы от ячеек
  или же ещё как-то оптимиз рендеринг. типо cached-draw
2) хранить пиксели как числа
...
оптимизация
  ...
  22) и картинки и текущий фрейм перерендериваются. можно ли переисп?
    linked cels. оптимизация  
  23) лаги на добавление и удаление фреймов слоёв

links сохранябтся в бекапе?
...
16) highlight color selection for black
...
19) spritesheet улучшить размеры

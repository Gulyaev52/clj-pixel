4) view для перемещения
  по горизонтали
    сдвигаем
      подсвечиваться должна позиция между ячейками
  но вертикали
    можем только менять местами
  превью это чёрный квадратик
  анимация не нужна
  
  можно двигать фреймы
    залочить по x и по области?
  можно двигать слои
    залочить по x и по области?
18) черный цвет в гифке. иногда работает а иногда нет
21) валидация размера нового проекта и при ресайзе

протестить экшены типо esc
;; geometry/visit-connected-pixels vs geometry/flood-fill; circle pixels

;; батчить эвенты
13) где-то массив координат а где-то объект
ещё раз проверить а так ли это
в селектион переписать с тюпла на обычным объект поинт+колор
объект или же массив?

14) undo когда есть селектион. вставка когда выделен объект
...
18) превью в таймлайне не видно на 512 512

17) дизайн
  1) сделать норм подсветку для активной ячейки
  2) ui-kit
  3) придумать как и что будет
  4) динамический размер поля для рис.
    нужно вычислять viewport.
    на ресайз окна нужно перевычислять?
  5) дизайн примерно как в https://www.pixilart.com/draw

  1) слева панель с инструментами
    откуда брать иконки
    компоненты?
  2) над канвасом строка с опциями
  3) канвас на весь размер

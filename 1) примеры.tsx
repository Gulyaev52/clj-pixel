  ...
  картинка
    экспорт
      две режима
        ...
        картинка
          можно выбрать какие фреймы и слои будут эксп
            all
            selected
            visible layers
          direction
          ...
          file_prefix
          file_format
            когда выбираешь png/jpg, то если 
              фрейм 1 то показываем как есть
              если много то гридом в две колонки
            когда выбираешь gif
              показывать гифку
              добавлять опцию. repeat
        split by layers (имена слоёв).
        спредшит
          колонки
          строки
    импорт из картинки
...
17) пофиксить грид
16) блок редактирования
17) теги?
10) переделать sprite preview
13) применить изменения на действие
9) опасити у слоя

...
4) colorpicker инструмент и добавление в палетку.
добавить цвета в палетку с фрейма
6) сравнение цветов в разных форматах
7) при добавление цвета и открытие заново нужно что бы был выбран последний добавленный
либо же что бы была возможность добавить его
9) переименовать colors в current-colors

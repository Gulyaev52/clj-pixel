...
13) выделения.
  10) переименоавть select -> selection
  11) пофиксить выделение. отрефакторить
  ;; todo: поменять цвет так как плохо видно. например на краснои
...
43) проверить различные прозрачности. shading для eraser
21) новый проект
  с отличным размером
